...
void main() {
  test('inspectContainer parses tty', () async {
    final t = FakeTransport.always(
      http.Response('{"Id":"a","Name":"/w","Config":{"Image":"nginx","Tty":true},"State":{"Status":"running"}}', 200),
    );
