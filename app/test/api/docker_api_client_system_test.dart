...
FakeTransport systemFake() => FakeTransport()
  ..onGet('/info', (_) => http.Response('{"ServerVersion":"27.0.3","NCPU":8,"Driver":"overlay2"}', 200))
  ..onGet('/version', (_) => http.Response('{"Version":"27.0.3","ApiVersion":"1.46"}', 200))
  ..onGet('/system/df',
      (_) => http.Response('{"Images":[{"Size":100}],"Containers":[],"Volumes":[],"BuildCache":[]}', 200))
  ..onPost(RegExp('.*'), (_) => http.Response('', 200));

void main() {
  test('getInfo/getVersion/getDiskUsage parse their endpoints', () async {
    final c = DockerApiClient(systemFake());
